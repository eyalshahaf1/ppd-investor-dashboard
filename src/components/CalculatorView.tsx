    ...
    <div className="dashboard-grid calculator-grid">
      ...
      <section className="span-6 panel calc-pricing">
        ...
        <div className="control-grid">
          ...
          <AssumptionControl name="takeRate" label="Contribution instruction fee" help="0.5% of verified allocation value. Separately invoiced to the employer or rail partner. Not deducted from, held, pooled, transferred, or invested by PPD." value={assumptions.takeRate} min={0} max={2} step={0.05} onChange={(value) => onAssumptionChange("takeRate", value)} />
